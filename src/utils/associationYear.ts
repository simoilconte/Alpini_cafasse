...
/**
 * Gets the end date of an association year (August 31st of the end year).
 *
 * This is used to calculate membership expiration dates.
 *
 * @param endYear - The end year of the association year
 * @returns A Date object representing August 31st of the given year
 *
 * @example
 * getAssociationYearEnd(2026)
 * // Returns: Date representing August 31, 2026
 *
 * @validates Requirements 3.4
 */
export function getAssociationYearEnd(endYear: number): Date {
  // Month is 0-indexed in JavaScript, so 7 = August
  // Day 31 = August 31st
